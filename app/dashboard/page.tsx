...
export default function DashboardPage() {
  ...
  const [deliveryDates, setDeliveryDates] = useState<{ date3Days: string; date5Days: string } | null>(null);
  ...
  useEffect(() => {
    ...
    setDeliveryDates({
      ...
      date5Days: formatDate(date5Days)
    });
  }, []);
        ...
        <div style={{ paddingTop: '1rem', display: 'flex', flexDirection: 'row', gap: '2.5rem', alignItems: 'flex-start' }}>
          ...
          <div style={{ maxWidth: '520px', paddingTop: '0.25rem' }}>
            ...
            <div style={{ marginTop: '1.25rem', display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
              <div>
                <div style={{ fontSize: '13px', fontWeight: 600, color: '#111', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                ...
                <div style={{ marginTop: '0.5rem', fontSize: '24px', fontWeight: 800, lineHeight: 1.6 }}>
                  {deliveryDates ? (
                    <>
                      <div>
                        <span style={{ color: '#111' }}>NY, NJ, DE, PA, CT: </span>
                        <span style={{ color: '#dc2626', fontWeight: 900 }}>{deliveryDates.date3Days}</span>
                        <span style={{ color: '#dc2626', fontSize: '15px', marginLeft: '0.3rem' }}></span>
                      </div>
                      <div style={{ marginTop: '0.25rem' }}>
                        <span style={{ color: '#111', fontWeight: 400 }}>Other states in the US: </span>
                        <span style={{ color: '#111', fontWeight: 900 }}>{deliveryDates.date5Days}</span>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div style={{ marginTop: '0.25rem' }}>
                        <span style={{ color: '#111', fontWeight: 400 }}>Other states in the US: </span>
                        <span style={{ color: '#111', fontWeight: 900 }}>...</span>
                      </div>
                    </>
                  )}
                </div>
              ...
              <div>
                ...
                <div style={{ marginTop: '0.5rem', fontSize: '22px', fontWeight: 700, lineHeight: 1.6, color: '#111' }}>
                  <div>+ $5.00</div>
